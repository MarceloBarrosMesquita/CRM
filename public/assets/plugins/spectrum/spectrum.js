!function (e) {
    ...
    var e, Ie = {
            ...
            disabled: !1,
            offset: null
        }, Ve = [], We = !!/msie/i.exec(window.navigator.userAgent),
    ...
    function n(e, t) {
        var a, o, r, n, h = function (e, t) {
            ...
            u = h.callbacks, f = (a = Qe, function () {
                var e = this, t = arguments;
                r && clearTimeout(n), !r && n || (n = setTimeout(function () {
                    n = null, a.apply(e, t)
                }, o))
            }), p = !(o = 10), g = !1, b = 0, m = 0, v = 0, x = 0, y = 0, T = 0, w = 0, _ = 0, k = 0, P = 0, C = 1, S = [],
            M = [], z = {}, j = h.selectionPalette.slice(0), A = h.maxSelectionSize, R = "sp-dragging", F = !1,
            H = null, L = e.ownerDocument, O = (L.body, De(e)), Q = !1, E = De($e, L).addClass(c),
            ...
            ae = te ? De(Ke).addClass(c).addClass(h.className).addClass(h.replacerClassName) : De([]), oe = te ? ae : O,
            re = ae.find(".sp-preview-inner"), ne = h.color || ee && O.val(), se = !1, ie = h.preferredFormat,
            le = !h.showButtons || h.clickoutFiresChange, ce = !ne, ue = h.allowEmpty, fe = null, he = null, de = null,
            pe = null, ge = O.attr("id");
        ...
        function ye() {
            var a = Re(), e = De.map(M, function (e, t) {
        ...
        function He() {
            ...
            if (re.removeClass("sp-clear-display"), re.css("background-color", "transparent"), !a && ue) re.addClass("sp-clear-display"); else {
                ...
                if (Be || 1 === a.alpha ? re.css("background-color", n) : (re.css("background-color", "transparent"), re.css("filter", a.toFilter())), h.showAlpha) {
                    ...
                    We ? W.css("filter", tinycolor(i).toFilter({gradientType: 1}, r)) : (W.css("background", "-webkit-" + l), W.css("background", "-moz-" + l), W.css("background", "-ms-" + l), W.css("background", "linear-gradient(to right, " + i + ", " + r + ")"))
                }
                o = a.toString(t)
            }
        ...
        function Oe(e) {
            var t = Re(), a = !tinycolor.equals(t, se);
        ...
        var Ne = {
            show: Ce, hide: ze, toggle: Pe, reflow: Qe, option: function (e, t) {
            ...
            }, disable: Ee, offset: function (e) {
                h.offset = e, Qe()
            }, set: function (e) {
                Ae(e), Oe()
            }, get: Re, destroy: function () {
        ...
        function o(e) {
            if (c) {
                ...
                var t = e.originalEvent && e.originalEvent.touches && e.originalEvent.touches[0],
                    a = t && t.pageX || e.pageX, o = t && t.pageY || e.pageY, r = Math.max(0, Math.min(a - u.left, h)),
            ...
            h = function (e, t) {
                ...
                var a = function (e) {
                    ...
                    "object" == typeof e && (e.hasOwnProperty("r") && e.hasOwnProperty("g") && e.hasOwnProperty("b") ? (t = function (e, t, a) {
                        ...
                        var o = c.floor(e), r = e - o, n = a * (1 - t), s = a * (1 - r * t), i = a * (1 - (1 - r) * t),
                            l = o % 6;
                        return {
                            r: 255 * [a, s, n, n, i, a][l],
                            g: 255 * [i, a, a, s, n, n][l],
