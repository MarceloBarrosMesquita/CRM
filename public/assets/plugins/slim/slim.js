(function ($, undefined) {
    ...
    var Slim = function () {
        ...
        var snabbt = function () {
            ...
            var EASING_FUNCS = {linear: linearEasing, ease: ease, easeIn: easeIn, easeOut: easeOut};
            ...
            var createState = function (config) {
                ...
                var properties = {opacity: undefined, width: undefined, height: undefined};
                return {
        ...
        var blobToFile = function blobToFile(blob, name) {
            try {
                var file = new File([blob], name, {type: blob.type, lastModified: Date.now()});
                if (file.size > 0) {
                    return file
                }
            } catch (e) {
        ...
        var getImageAsCanvas = function getImageAsCanvas(src, size, callback) {
            ...
            loadImage.parseMetaData(src, function (meta) {
                var options = {canvas: true, crossOrigin: crossOrigin};
                if (size) {
        ...
        var getAutoCropRect = function getAutoCropRect(width, height, ratioOut) {
            var x, y, w, h, ratioIn = height / width;
            if (ratioIn < ratioOut) {
                h = height;
                w = h / ratioOut;
                x = (width - w) * .5;
        ...
        var transformCanvas = function transformCanvas(canvas) {
            ...
            var rotation = transforms.rotation, crop = transforms.crop, size = transforms.size,
                filters = transforms.filters, minSize = transforms.minSize;
            if (crop) {
                ...
                if (rotation === 90) {
                    ...
                    ctx.drawImage(canvas, (1 - py) * canvas.width - canvas.width * ph, crop.x, crop.height, crop.width, -result.height * .5, -result.width * .5, result.height, result.width)
                } else if (rotation === 180) {
                    ctx.translate(result.width * .5, result.height * .5);
                    ctx.rotate(-180 * Math.PI / 180);
                    ctx.drawImage(canvas, (1 - (px + pw)) * space.width, (1 - (py + ph)) * space.height, pw * space.width, ph * space.height, -result.width * .5, -result.height * .5, result.width, result.height)
                } else if (rotation === 270) {
                    ctx.translate(result.width * .5, result.height * .5);
                    ctx.rotate(-270 * Math.PI / 180);
                    ctx.drawImage(canvas, crop.y, (1 - px) * canvas.height - canvas.height * pw, crop.height, crop.width, -result.height * .5, -result.width * .5, result.height, result.width)
                } else {
                    ctx.drawImage(canvas, crop.x, crop.y, crop.width, crop.height, 0, 0, result.width, result.height)
                }
            }
            if (size) {
        ...
        var sharpen = function sharpen(mix) {
            return function (pixels, w, h) {
                var weights = [0, -1, 0, -1, 5, -1, 0, -1, 0], katet = Math.round(Math.sqrt(weights.length)),
                    half = katet * .5 | 0, dstData = createImageData(w, h), dstBuff = dstData.data,
                    srcBuff = pixels.data, y = h, x = void 0;
                while (y--) {
                    x = w;
                    while (x--) {
        ...
        var cloneData = function cloneData(obj) {
            ...
            dupe.output.image = obj.output.image;
            return dupe
        };
        ...
        var CropArea = function () {
            ...
            return function () {
                ...
                _createClass(CropArea, [{
                    ...
                    key: "rescale", value: function rescale(scale) {
                        if (scale === 1) {
                            return
                        }
                        this._interaction = null;
                    ...
                    key: "limit", value: function limit(width, height) {
                        this._space.width = width;
                        this._space.height = height
                    }
                }, {
                    key: "offset", value: function offset(x, y) {
                        this._space.x = x;
                        this._space.y = y
                    }
                }, {
                    key: "resize", value: function resize(x, y, width, height) {
                        this._interaction = null;
                        this._rect = {
                    ...
                    key: "handleEvent", value: function handleEvent(e) {
                        switch (e.type) {
                            case"touchstart":
                            case"pointerdown":
                            case"mousedown": {
                    ...
                    key: "_onStartDrag", value: function _onStartDrag(e) {
                        ...
                        this._interaction = {type: e.target.className, offset: getEventOffsetScroll(e)};
                    ...
                    key: "_onDrag", value: function _onDrag(e) {
                        e.preventDefault();
                    ...
                    key: "_onStopDrag", value: function _onStopDrag(e) {
                        e.preventDefault();
                    ...
                    key: "minWidth", set: function set(value) {
                        this._minWidth = Math.max(value, 1)
                    }
                }, {
                    key: "minHeight", set: function set(value) {
                        this._minHeight = Math.max(value, 1)
                    }
                }, {
                    key: "ratio", set: function set(value) {
                        this._ratio = value
                    }
                }]);
                return CropArea
        ...
        var ImageEditor = function () {
            ...
            var ImageEditor = function () {
                ...
                _createClass(ImageEditor, [{
                    ...
                    key: "dirty", value: function dirty() {
                        this._dirty = true
                    }
                }, {
                    key: "handleEvent", value: function handleEvent(e) {
                    ...
                    key: "_redrawWrapper", value: function _redrawWrapper() {
                    ...
                    key: "_onGridInput", value: function _onGridInput() {
                        this._redrawCropMask()
                    }
                }, {
                    key: "_onGridChange", value: function _onGridChange() {
                        this._redrawCropMask()
                    }
                }, {
                    key: "_updateWrapperRotation", value: function _updateWrapperRotation() {
                    ...
                    key: "_updateWrapperScale", value: function _updateWrapperScale() {
                    ...
                    key: "_cancel", value: function _cancel() {
                        if (this._rotating) {
                            return
                        }
                    ...
                    key: "_confirm", value: function _confirm() {
                        if (this._rotating) {
                            return
                        }
                        var isTilted = this._wrapperRotation % 180 !== 0;
                    ...
                    key: "_rotate", value: function _rotate() {
                        var _this3 = this;
                        if (this._rotating) {
                            return
                        }
                    ...
                    key: "_showCropper", value: function _showCropper() {
                        snabbt(this._stage, {easing: "ease", duration: 250, fromOpacity: 0, opacity: 1})
                    }
                }, {
                    key: "_hideCropper", value: function _hideCropper() {
                        snabbt(this._stage, {duration: 0, fromOpacity: 0, opacity: 0})
                    }
                }, {
                    key: "_redrawCropMask", value: function _redrawCropMask() {
                        var _this4 = this;
                        var rotation = this._wrapperRotation % 360;
                        var scale = this._wrapperScale;
                        var canvas = {width: this._wrapper.offsetWidth, height: this._wrapper.offsetHeight};
                    ...
                    key: "open", value: function open(image, ratio, crop, rotation, complete) {
                        var _this5 = this;
                    ...
                    key: "_redrawCropper", value: function _redrawCropper(rect) {
                        var isTilted = this._wrapperRotation % 180 !== 0;
                        ...
                        var crop = null;
                        if (rect) {
                            crop = {x: rect.x * sw, y: rect.y * sh, width: rect.width * sw, height: rect.height * sh}
                        } else {
                    ...
                    key: "_redraw", value: function _redraw() {
                        ...
                        this._previewSize = {width: width, height: height};
                    ...
                    key: "hide", value: function hide() {
                        ...
                        snabbt(this._utilsGroup.childNodes, {fromOpacity: 1, opacity: 0, duration: 250});
                        snabbt(this._btnGroup.childNodes, {fromOpacity: 1, opacity: 0, delay: 200, duration: 350});
                    ...
                    key: "showRotateButton", set: function set(enabled) {
                        if (enabled) {
        ...
        var FileHopper = function () {
            ...
            return function () {
                ...
                _createClass(FileHopper, [{
                    ...
                    key: "areValidDataTransferFiles", value: function areValidDataTransferFiles(files) {
                    ...
                    key: "areValidDataTransferItems", value: function areValidDataTransferItems(items) {
                    ...
                    key: "_onDrop", value: function _onDrop(e) {
                        e.preventDefault();
                        var remote = null;
                        if (this._allowURLs) {
                            var url = void 0;
                        ...
                        this._element.dispatchEvent(new CustomEvent("file-drop", {detail: getOffsetByEvent(e)}));
                        this._element.dispatchEvent(new CustomEvent("change"));
                        this._dragPath = null
                    }
                }, {
                    key: "_onDragOver", value: function _onDragOver(e) {
                        e.preventDefault();
                    ...
                    key: "_onDragLeave", value: function _onDragLeave(e) {
                        this._element.dispatchEvent(new CustomEvent("file-out", {detail: getOffsetByEvent(e)}));
                        this._dragPath = null
                    }
                }, {
                    key: "destroy", value: function destroy() {
                    ...
                    key: "allowURLs", set: function set(value) {
                        this._allowURLs = value
                    }
                }, {
                    key: "accept", set: function set(mimetypes) {
        ...
        var Popover = function () {
            return function () {
                ...
                _createClass(Popover, [{
                    ...
                    key: "inner", set: function set(element) {
                        this._inner = element;
                    ...
                    key: "className", set: function set(value) {
        ...
        var CropType = {AUTO: "auto", INITIAL: "initial", MANUAL: "manual"};
        ...
        var Slim = function () {
            ...
            _createClass(Slim, [{
                key: "setRotation", value: function setRotation(rotation, callback) {
                ...
                key: "setSize", value: function setSize(dimensions, callback) {
                ...
                key: "setForceSize", value: function setForceSize(dimensions, callback) {
                    if (typeof dimensions === "string") {
                        dimensions = stringToSize(dimensions)
                    }
                    if (!dimensions || !dimensions.width || !dimensions.height) {
                ...
                key: "setRatio", value: function setRatio(ratio, callback) {
                    var _this11 = this;
                ...
                key: "isAttachedTo", value: function isAttachedTo(element) {
                    return this._element === element || this._originalElement === element
                }
            }, {
                key: "isDetached", value: function isDetached() {
                    return this._element.parentNode === null
                }
            }, {
                key: "load", value: function load(src) {
                    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                ...
                key: "upload", value: function upload(callback) {
                ...
                key: "crop", value: function crop(rect, callback) {
                    this._crop(rect.x, rect.y, rect.width, rect.height, callback)
                }
            }, {
                key: "containsImage", value: function containsImage() {
                    return this._data.input.name !== null
                }
            }, {
                key: "_canInstantEdit", value: function _canInstantEdit() {
                    return this._options.instantEdit && !this._isInitialising
                }
            }, {
                key: "_getFileInput", value: function _getFileInput() {
                    return this._element.querySelector("input[type=file]")
                }
            }, {
                key: "_getInitialImage", value: function _getInitialImage() {
                    return this._element.querySelector("img")
                }
            }, {
                key: "_getInputElement", value: function _getInputElement() {
                    return this._getFileInput() || this._getInitialImage()
                }
            }, {
                key: "_getRatioSpacerElement", value: function _getRatioSpacerElement() {
                    return this._element.children[0]
                }
            }, {
                key: "_isImageOnly", value: function _isImageOnly() {
                    return this._input.nodeName !== "INPUT"
                }
            }, {
                key: "_isFixedRatio", value: function _isFixedRatio() {
                    return this._options.ratio.indexOf(":") !== -1
                }
            }, {
                key: "_isAutoCrop", value: function _isAutoCrop() {
                    return this._data.actions.crop.type === CropType.AUTO
                }
            }, {
                key: "_toggleButton", value: function _toggleButton(action, state) {
                    toggleDisplayBySelector('.slim-btn[data-action="' + action + '"]', state, this._element)
                }
            }, {
                key: "_clearState", value: function _clearState() {
                    this._state = [];
                    this._updateState()
                }
            }, {
                key: "_removeState", value: function _removeState(state) {
                ...
                key: "_addState", value: function _addState(state) {
                ...
                key: "_updateState", value: function _updateState() {
                    if (!this._element) {
                        return
                    }
                ...
                key: "_onInit", value: function _onInit() {
                    var _this13 = this;
                ...
                key: "_updateProgress", value: function _updateProgress(progress) {
                ...
                key: "_startProgress", value: function _startProgress(cb) {
                    var _this14 = this;
                    if (!this._element) {
                        return
                    }
                    ...
                    this._stopProgressLoop(function () {
                        ...
                        snabbt(ring, {
                            fromOpacity: 0, opacity: 1, duration: 250, complete: function complete() {
                                _this14._progressEnabled = true;
                                if (cb) {
                                    cb()
                                }
                ...
                key: "_stopProgress", value: function _stopProgress() {
                    var _this15 = this;
                    if (!this._element) {
                        return
                    }
                    ...
                    snabbt(ring, {
                        fromOpacity: 1, opacity: 0, duration: 250, complete: function complete() {
                            loader.removeAttribute("style");
                            ring.removeAttribute("style");
                ...
                key: "_startProgressLoop", value: function _startProgressLoop() {
                    if (!this._element) {
                        return
                    }
                    var loader = this._element.querySelector(".slim-loader");
                    ...
                    snabbt(ring, {fromOpacity: 0, opacity: 1, duration: 250})
                }
            }, {
                key: "_stopProgressLoop", value: function _stopProgressLoop(callback) {
                    if (!this._element) {
                        return
                    }
                    var loader = this._element.querySelector(".slim-loader");
                ...
                key: "_isButtonAllowed", value: function _isButtonAllowed(button) {
                    if (button === "edit") {
                ...
                key: "_fallback", value: function _fallback() {
                    var area = create("div", "slim-area");
                ...
                key: "_getIntro", value: function _getIntro() {
                    return this._element.querySelector(".slim-result .in")
                }
            }, {
                key: "_getOutro", value: function _getOutro() {
                    return this._element.querySelector(".slim-result .out")
                }
            }, {
                key: "_getInOut", value: function _getInOut() {
                    return this._element.querySelectorAll(".slim-result img")
                }
            }, {
                key: "_getDrip", value: function _getDrip() {
                    if (!this._drip) {
                ...
                key: "_throwError", value: function _throwError(error) {
                ...
                key: "_openFileDialog", value: function _openFileDialog() {
                    this._removeError();
                    this._input.click()
                }
            }, {
                ...
                key: "_onInvalidFileDrop", value: function _onInvalidFileDrop() {
                    this._onInvalidFile();
                ...
                key: "_onInvalidFile", value: function _onInvalidFile() {
                ...
                key: "_onImageTooSmall", value: function _onImageTooSmall() {
                    var error = this._options.statusImageTooSmall.replace("$0", this._options.minSize.width + " × " + this._options.minSize.height);
                    this._throwError(error)
                }
            }, {
                key: "_onOverWeightFile", value: function _onOverWeightFile() {
                    var error = this._options.statusFileSize.replace("$0", this._options.maxFileSize);
                    this._throwError(error)
                }
            }, {
                key: "_onLocalURLProblem", value: function _onLocalURLProblem(error) {
                    this._throwError(this._options.statusLocalUrlProblem || error)
                }
            }, {
                key: "_onRemoteURLProblem", value: function _onRemoteURLProblem(error) {
                    this._throwError(error)
                }
            }, {
                key: "_onFileOver", value: function _onFileOver(e) {
                ...
                key: "_onFileOut", value: function _onFileOut(e) {
                    this._removeState("file-over");
                ...
                key: "_onDropFile", value: function _onDropFile(e) {
                    var _this17 = this;
                    this._removeState("file-over");
                    var drip = this._getDrip();
                    var matrix = snabbt.createMatrix();
                ...
                key: "_load", value: function _load(resource, callback) {
                    var _this18 = this;
                    ...
                    getImageAsCanvas(file, internalCanvasSize, function (image, meta) {
                        ...
                        _this18._options.willLoadCanvas.apply(_this18, [image, function (imageOut) {
                            _this18._loadCanvas(imageOut, function (isUploading) {
                ...
                key: "_loadCanvas", value: function _loadCanvas(image, ready, complete, options) {
                    var _this19 = this;
                    if (!options) {
                        options = {}
                    }
                ...
                key: "_applyTransforms", value: function _applyTransforms(image, ready) {
                    var _this20 = this;
                    var actions = clone(this._data.actions);
                    actions.filters = {sharpen: this._options.filterSharpen / 100};
                    if (this._options.forceMinSize) {
                        actions.minSize = this._options.minSize
                    } else {
                        actions.minSize = {width: 0, height: 0}
                    }
                ...
                key: "_onTransformCanvas", value: function _onTransformCanvas(ready) {
                    this._options.willTransform.apply(this, [this.data, ready, this])
                }
            }, {
                key: "_appendEditor", value: function _appendEditor() {
                    var _this21 = this;
                    if (this._imageEditor) {
                        return
                    }
                ...
                key: "_scaleDropArea", value: function _scaleDropArea(ratio) {
                ...
                key: "_onCancel", value: function _onCancel(e) {
                ...
                key: "_onConfirm", value: function _onConfirm(e) {
                    var _this22 = this;
                ...
                key: "_cropAuto", value: function _cropAuto() {
                ...
                key: "_crop", value: function _crop(x, y, width, height) {
                    ...
                    this._output.value = "";
                    this._data.actions.crop = {x: x, y: y, width: width, height: height};
                    this._data.actions.crop.type = cropType;
                    this._manualTransform(callback)
                }
            }, {
                key: "_manualTransform", value: function _manualTransform(callback) {
                    var _this23 = this;
                    this._startProgressLoop();
                    this._addState("busy");
                    this._applyTransforms(this._data.input.image, function (transformedImage) {
                ...
                key: "_storeServerResponse", value: function _storeServerResponse(data) {
                    if (this._isRequired) {
                ...
                key: "_store", value: function _store(data) {
                    if (this._isRequired) {
                        this._input.required = false
                    }
                ...
                key: "_upload", value: function _upload(data, callback) {
                    var _this25 = this;
                    this.requestOutput(function (fileData, formData) {
                        ...
                        if (typeof _this25._options.service === "string") {
                            ...
                            _this25._options.service.apply(_this25, [_this25._options.serviceFormat === "file" ? fileData : formData, onProgress, onSuccess, onError, _this25])
                        }
                    }, data)
                }
            }, {
                key: "requestOutput", value: function requestOutput(cb, data) {
                    var _this26 = this;
                    ...
                    loadImage.parseMetaData(this._data.input.file, function (imageData) {
                        var fileData = [];
                ...
                key: "_showEditor", value: function _showEditor() {
                    SlimPopover.className = this._options.popoverClassName;
                    SlimPopover.show();
                    this._imageEditor.show()
                }
            }, {
                key: "_hideEditor", value: function _hideEditor() {
                    var _this27 = this;
                ...
                key: "_showPreview", value: function _showPreview(intro, callback) {
                    snabbt(intro, {
                        fromPosition: [0, 50, 0],
                        position: [0, 0, 0],
                        fromScale: [1.5, 1.5],
                ...
                key: "_hideResult", value: function _hideResult(callback) {
                ...
                key: "_showButtons", value: function _showButtons(callback) {
                    if (!this._btnGroup) {
                        return
                    }
                ...
                key: "_hideButtons", value: function _hideButtons(callback) {
                    var _this28 = this;
                    if (!this._btnGroup) {
                        return
                    }
                ...
                key: "_hideStatus", value: function _hideStatus() {
                    var statusNode = this._element.querySelector(".slim-upload-status");
                    statusNode.style.opacity = 0
                }
            }, {
                key: "_doEdit", value: function _doEdit() {
                    var _this29 = this;
                    if (!this._data.input.image) {
                        return
                    }
                    ...
                    this._imageEditor.open(this._data.input.image, this._options.ratio === "free" ? null : this._ratio, this._data.actions.crop, this._data.actions.rotation, function () {
                        _this29._showEditor();
                ...
                key: "_doRemove", value: function _doRemove(done) {
                    var _this30 = this;
                    if (this._isImageOnly()) {
                        return
                    }
                ...
                key: "_doUpload", value: function _doUpload(callback) {
                    var _this31 = this;
                    if (!this._data.input.image) {
                        return
                    }
                ...
                key: "_doDownload", value: function _doDownload() {
                ...
                key: "_doDestroy", value: function _doDestroy() {
                    var _this32 = this;
                ...
                key: "service", set: function set(service) {
                    this._options.service = service
                }
            }, {
                key: "size", set: function set(dimensions) {
                    this.setSize(dimensions, null)
                }
            }, {
                key: "rotation", set: function set(rotation) {
                    this.setRotation(rotation, null)
                }
            }, {
                key: "forceSize", set: function set(dimensions) {
                    this.setForceSize(dimensions, null)
                }
            }, {
                key: "ratio", set: function set(ratio) {
        ...
        (function () {
            ...
            Slim.supported = function () {
                return !(Object.prototype.toString.call(window.operamini) === "[object OperaMini]" || typeof window.addEventListener === "undefined" || typeof window.FileReader === "undefined" || !("slice" in Blob.prototype) || typeof window.URL === "undefined" || typeof window.URL.createObjectURL === "undefined")
            }();
