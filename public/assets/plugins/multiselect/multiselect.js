...
(function (root, factory) {
    ...
    Multiselect.prototype = {
        ...
        createOptionValue: function (element, isGroupOption) {
            ...
            //this.$popupContainer.find('.container-pussy-items').append($option);
            this.$popupContainer.find('.container-pussy-items').last().append($option);
            ...
            let idGroup = $(group).attr('id');
            this.$popupContainer.append($('<div />').addClass('container-pussy').attr('id', idGroup));
            this.$popupContainer.find('.container-pussy[id="' + idGroup + '"]').append($groupOption);
            this.$popupContainer.find('.container-pussy[id="' + idGroup + '"]').append($('<div />').addClass('container-pussy-items'));
